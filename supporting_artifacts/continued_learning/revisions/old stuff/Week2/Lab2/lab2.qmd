...
the dimensions of the data set is 30,463 rows and 15 columns
...
The data types used in this data set are printed out by using str(df) this shows us that we havee doubles, characters, and date data type.
...
#Code for question 5!
 ...
 ggplot(data = surveys, mapping = 
          aes(x= weight, y=hindfoot_length)) + geom_point(alpha=.2)
...
# Code for question 7
 ggplot(data = surveys, mapping = aes(x= weight, y=hindfoot_length)) +  
   geom_jitter(alpha=.2)+ facet_wrap(~species)
