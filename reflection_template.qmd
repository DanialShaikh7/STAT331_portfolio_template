...
-   I didn't use any of the rest of the join's in any of my work, but i found some examples through documentation.
-   `right_join()`

```{r wd-5-right}
df1 <- data.frame(id = c(1, 2, 3, 4, 5), name = c("Alice", "Bob", "Charlie", "Dave", "Eve"))
df2 <- data.frame(id = c(2, 4, 6), age = c(25, 35, 45))
